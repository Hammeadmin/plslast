...
import {
    Plus, Clock, Users, User, profile, CheckCircle, Filter, Search, X, Eye, Edit2, Trash2, Copy, Loader2, Calendar as CalendarIcon, List, AlertTriangle, Building2, MapPin, Briefcase, RefreshCw, DollarSign, CalendarPlus, Info, BarChart as ChartBar, UserCog, FileText, Shield, CheckSquare, Square, Menu as MenuIcon, Award, Download
...
type EmployerDashboardTab = 'overview' | 'postings' | 'schedule' | 'completed';

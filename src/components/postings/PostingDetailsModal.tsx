                    ...
                    <div className="flex justify-between items-start px-4 sm:px-6 py-3 sm:py-4 border-b">
                        <div>
                          ...
                          {currentUserRole !== 'employer' && (
                            <Link to={`/employer/${posting.employer_id}`} onClick={(e) => e.stopPropagation()} className="text-xs sm:text-sm text-gray-500 flex items-center mt-1 hover:text-blue-600 group">

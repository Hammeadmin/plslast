                    ...
                    <div className="bg-white shadow-xl rounded-lg p-4 sm:p-6 md:p-8">
                        ...
                        <>
                            <div className="border-t border-gray-200 pt-4 sm:pt-6 space-y-4 sm:space-y-6 mt-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div><label htmlFor="city" className="block text-sm font-medium text-gray-700 mb-1">Stad</label><input type="text" name="city" id="city" value={profileData.city || ''} onChange={handleInputChange} className="input-form" /></div>
                        ...
                        <div className="bg-white shadow-lg rounded-lg p-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                                ...
                                <div className="md:col-span-2 space-y-4">
                                    <div><label className="form-label">Namn</label><div className="relative"><UserCircle className="input-icon" /><input type="text" name="full_name" value={profileData.full_name || ''} onChange={handleInputChange} className="input-form pl-10" /></div></div>
                                    <div><label className="form-label">Email</label><div className="relative"><Mail className="input-icon" /><input type="email" value={profileData.email || ''} disabled className="input-form-disabled pl-10" /></div></div>
                                    <div><label className="form-label">Telefon</label><div className="relative"><Phone className="input-icon" /><input type="tel" name="phone_number" value={profileData.phone_number || ''} onChange={handleInputChange} className="input-form pl-10" /></div></div>
                                </div>
                            </div>
                        </div>

          ...
          <div>
            ...
            <div className="mt-8 bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Hur verifieras yrkespersoner?</h3>
                  <p className="mt-1 text-gray-600">
                    Vi verifierar alla yrkeslegitimationer, licenser och arbetshistorik innan yrkespersoner får ansöka om pass.
                  </p>
                </div>
                <div>

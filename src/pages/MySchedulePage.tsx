...
const MySchedulePage: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
            ...
            {selectedShiftEvent && (
                <ShiftDetailsModal
                    shift={{ id: selectedShiftEvent.event_id, title: selectedShiftEvent.title, location: selectedShiftEvent.location, start_time: format(parseISO(selectedShiftEvent.start_time), 'HH:mm'), end_time: format(parseISO(selectedShiftEvent.end_time), 'HH:mm'), date: format(parseISO(selectedShiftEvent.start_time), 'yyyy-MM-dd') }}
                    onClose={closeModal}
                />
            )}
